...
```php
    ...
    $app->route('/mia-message/add-in-channel', [\Mia\Auth\Handler\AuthHandler::class, \Mia\Message\Handler\AddUserInChannelHandler::class], ['POST', 'OPTIONS', 'HEAD'], 'mia-message.add-user-in-channel');
